package com.aishwaryagm.objectrecogniser.listeners;
...
public class ImageChildEventListener implements ChildEventListener {
    ...
    public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
        ...
        CallBackInterface callBackInterfaceObject = singletonHashMap.get(datasnapshotKey);
        ...
        if(visionDataHM.containsKey("labelAnnotations")){
            ...
            if(callBackInterfaceObject != null){
                try {
                    ...
                    callBackInterfaceObject.update(imageDescriptionArray);
                } catch (RemoteException e) {
                    Log.e("ERROR",String.format("Error during callback %s",e.getMessage()));
                    e.printStackTrace();
                }
            }else{
